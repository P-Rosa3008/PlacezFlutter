...
import 'package:placez/src/features/map/markers/repository/markers_repository.dart';
import 'package:placez/src/features/map/markers/repository/markers_repository_impl.dart';
import 'package:riverpod/riverpod.dart';

final markersProvider = StateNotifierProvider<MarkersProviders, AsyncValue<List<Marker>>>(
...
class MarkersProviders extends StateNotifier<AsyncValue<List<Marker>>> {
  ...
  MarkersProviders(this._markersRepository) : super(AsyncValue.data([Marker.initialState()]));
